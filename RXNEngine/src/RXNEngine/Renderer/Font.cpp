...
namespace RXNEngine {
	...
	Font::Font(const std::filesystem::path& filepath)
		: m_Path(filepath),	m_Data(new MSDFData())
	{
		...
		RXN_CORE_INFO("Loaded {} glyphs from font (out of {})", glyphsLoaded, charset.size());
		...
		RXN_CORE_ASSERT(remaining == 0, "Failed to pack font atlas!");
		...
		m_AtlasTexture = CreateAndCacheAtlas<uint8_t, float, 3, msdf_atlas::msdfGenerator>("FontAtlas", (float)emSize, m_Data->Glyphs, m_Data->FontGeometry, width, height);
