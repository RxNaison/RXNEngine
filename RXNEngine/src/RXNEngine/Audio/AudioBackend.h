...
namespace RXNEngine {
    ...
    public:
        ...
        virtual void UpdateListener(const glm::vec3& position, const glm::vec3& forward, const glm::vec3& up, const glm::vec3& velocity) = 0;
        ...
        virtual void UpdateSoundSource(void* sourceData, const glm::vec3& position, const glm::vec3& velocity, float volume, float pitch, float minDistance, float maxDistance, float occlusion, float spread = 0.0f) = 0;
        ...
        virtual void SetReverbPreset(int preset, float volume) {}
    };
}